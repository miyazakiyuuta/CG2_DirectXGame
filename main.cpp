...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	// 頂点リソース
	Microsoft::WRL::ComPtr<ID3D12Resource> vertexResource = vertexResource = CreateBufferResource(device, sizeof(VertexData) * modelData.vertices.size());

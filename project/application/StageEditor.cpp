...
void StageEditor::Update(){
    ...
    if(selectedObjectId_ != -1){
        ...
        if(found){
            ...
            stage_->SetInstanceColorById(selectedObjectId_, { originalColor.x, originalColor.y, originalColor.z, lerpedAlpha });
        }
    }
...
void StageEditor::DrawImGui(){
    ...
    EditorUIMode currentMode = (selectedObjectId_ != -1)
        ? EditorUIMode::SelectedEdit
        : uiMode_;

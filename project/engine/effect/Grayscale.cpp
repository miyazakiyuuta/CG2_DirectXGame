...
void Grayscale::Draw(uint32_t srcSrvIndex) {
...
void Grayscale::CreateGraphicsPipelineState() {
    CreateRootSignature();
    ...
    // VSはFullscreen（共通）、PSはGrayscale
    Microsoft::WRL::ComPtr<IDxcBlob> vertexShaderBlob =
        dxCommon_->CompileShader(L"resources/shaders/Fullscreen.VS.hlsl", L"vs_6_0");
    assert(vertexShaderBlob != nullptr);
    Microsoft::WRL::ComPtr<IDxcBlob> pixelShaderBlob =
        dxCommon_->CompileShader(L"resources/shaders/Grayscale.PS.hlsl", L"ps_6_0");

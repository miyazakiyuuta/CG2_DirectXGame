    ...
    for (auto& [name, group] : particleGroups_) {
        ...
        for (std::list<Particle>::iterator particleIterator = group.particles.begin();
            ...
            if (numInstance < kNumMaxInstance) {
                ...
                Matrix4x4 worldMatrix = Matrix4x4::Scale(particleIterator->transform.scale) * rotateZMatrix * billboardMatrix * Matrix4x4::Translate(particleIterator->transform.translate);
...
void ParticleManager::Draw()
{
    ...
    // Debug: ensure Draw is being called
    Log(std::string("ParticleManager::Draw called\n"));
